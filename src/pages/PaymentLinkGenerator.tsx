...
const PaymentLinkGenerator: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 animate-fade-in">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Payment Link Generator</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6">Payment Details</h2>
            ...
            <div>
              ...
              <div className="flex rounded-xl overflow-hidden border border-slate-600">
                ...
                <select
                  ...
                  className="px-3 sm:px-4 py-3 bg-slate-600 text-white border-l border-slate-500 focus:outline-none text-sm sm:text-base"
                >
        ...
        <div className="space-y-4 sm:space-y-6">
          {generatedLink ? (
            <>
              {/* Success Card */}
              <div className="bg-gradient-to-br from-green-500/10 to-teal-500/10 border border-green-500/20 rounded-2xl p-4 sm:p-6">
                <h3 className="text-base sm:text-lg font-bold text-white mb-4">Payment Link Generated!</h3>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                      <input
                        ...
                        value={generatedLink}
                        readOnly
                        className="flex-1 px-3 py-2 bg-slate-700 text-white text-xs sm:text-sm rounded-lg border border-slate-600 font-mono"
                      />
                      <button
                        onClick={() => copyToClipboard(generatedLink)}
                        className="p-2 bg-teal-500 hover:bg-teal-400 text-white rounded-lg transition-colors duration-200 self-center sm:self-auto"
                      >
              ...
              <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-4 sm:p-6">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-white">QR Code</h3>
                </div>
                <QRCodeGenerator value={generatedLink} size={200} />
              </div>
            </>
          ) : (
