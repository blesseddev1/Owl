  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="p-4 sm:p-6 bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-sm">Total Volume</span>
            <CheckCircle className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-xl sm:text-2xl font-bold text-white">${totalVolume.toLocaleString()}</p>
        ...
        <div className="p-4 sm:p-6 bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl sm:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between mb-2">
